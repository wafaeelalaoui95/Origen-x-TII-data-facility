...
export const STATION_STAGING = {
  ...
  "home-mop":      { pos: [-0.05,-1.00], ry: 0,         pose: "wipeSurface" },
  ...
  // MOBILITY / LOCOMOTION — A2 biped, 2 robots per station (facility.js lays out both)
  "loco-door":     { pos: [-0.20, 1.05], ry: Math.PI,     pose: "openDoorR" },
